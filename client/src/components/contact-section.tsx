...
export function ContactSection() {
  ...
  return (
    <section id="contact" ref={ref} className={`py-20 gradient-bg dark:dark-gradient-bg ${isInView ? "animate-wave-form" : "opacity-0"
      }`}>
        ...
        <div className="max-w-4xl mx-auto animate-slide-up">
          ...
          <div className="mb-10 space-y-6">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="mailto:firstwaveasia@gmail.com"
              ...
              { /* mailto:firstwaveasia@gmail.com?subject=Partnership Inquiry - FirstWave */}
              <a
                href="mailto:firstwaveasia@gmail.com?subject=Partnership%20Inquiry%20-%20FirstWave"
            ...
            <p className="text-lg opacity-90">
              Email us: <span className="font-bold">firstwaveasia at gmail.com</span>
            </p>
          </div>
